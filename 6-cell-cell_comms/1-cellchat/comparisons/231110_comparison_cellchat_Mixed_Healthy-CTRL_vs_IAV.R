...
### Chord diagram to visualise specific groups

group.merged <- c(rep("Basal_SERPINE1+", 10), rep("Basal_SERPINE2+", 6)) 
...
group.cellType <- c(rep("Basal_SERPINE1+", 1), rep("Basal_SERPINE2+", 1), rep("iavEpi", 1), rep("iavClub_SAA1+", 1), rep("iavAT2_lip", 1))
group.cellType <- factor(group.cellType, levels = c("Basal_SERPINE1+", "Basal_SERPINE2+", "iavEpi", 'iavClub_SAA1+', 'iavAT2_lip'))
...
gg1 <- netAnalysis_signalingChanges_scatter(cellchat, idents.use = "Basal_SERPINE1+", signaling.exclude = "MIF")
gg2 <- netAnalysis_signalingChanges_scatter(cellchat, idents.use = "Basal_SERPINE2+", signaling.exclude = c("MIF"))
gg3 <- netAnalysis_signalingChanges_scatter(cellchat, idents.use = "iavEpi", signaling.exclude = "MIF")
gg4 <- netAnalysis_signalingChanges_scatter(cellchat, idents.use = "iavClub_SAA1+", signaling.exclude = c("MIF"))
gg5 <- netAnalysis_signalingChanges_scatter(cellchat, idents.use = "iavAT2_lip", signaling.exclude = c("MIF"))
gg6 <- netAnalysis_signalingChanges_scatter(cellchat, idents.use = "SupraB_KRT16+", signaling.exclude = c("MIF"))
