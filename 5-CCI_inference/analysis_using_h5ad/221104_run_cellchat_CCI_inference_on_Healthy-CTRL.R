...
ad_object <- ad$read_h5ad("../../data/Healthy-CTRL_annotated.h5ad")
...
head(df.net)
write.table(df.net, sep = ',', row.names = FALSE, '../inferences/Healthy-CTRL_cellchat_net.csv')
...
saveRDS(cellchat, file = "../../data//Healthy-CTRL_annotated.rds")
