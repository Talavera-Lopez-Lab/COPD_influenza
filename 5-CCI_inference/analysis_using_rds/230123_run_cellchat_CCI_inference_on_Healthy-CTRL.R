...
cellchat <- readRDS("/Users/carlos.lopez/github/COPD_influenza/data/Healthy-CTRL_anotated.rds")
cellchat
...
gg2 <- netAnalysis_signalingRole_scatter(cellchat, signaling = c("FN1", "TGFb"))
gg1 + gg2
...
plotGeneExpression(cellchat, signaling = "CADM")
