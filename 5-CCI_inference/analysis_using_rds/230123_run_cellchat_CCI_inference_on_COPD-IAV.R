...
ad_object <- ad$read_h5ad("../data/COPD-IAV_anotated.h5ad")
...
head(df.net)
write.table(df.net, sep = ',', row.names = FALSE, './inferences/COPD-IAV_cellchat_net.csv')
...
saveRDS(cellchat, file = "/Users/carlos.lopez/Downloads/cellchat_objects/COPD-IAV_anotated.rds")
