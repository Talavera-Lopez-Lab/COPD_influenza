...
ad_object <- ad$read_h5ad("../../../data/Basal_Healthy-CTRL_anotated.h5ad")
...
head(df.net)
write.table(df.net, sep = ',', row.names = FALSE, 'Mixed_Healthy-CTRL_cellchat_net.csv')
...
saveRDS(cellchat, file = "../../../data/Basal_Healthy-CTRL_anotated.rds")
