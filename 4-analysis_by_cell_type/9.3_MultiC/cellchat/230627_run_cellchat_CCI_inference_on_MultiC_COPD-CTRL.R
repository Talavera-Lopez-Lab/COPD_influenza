...
ad_object <- ad$read_h5ad("../../../data/MultiC_COPD-CTRL_anotated.h5ad")
...
head(df.net)
write.table(df.net, sep = ',', row.names = FALSE, './inferences/MultiC_COPD-CTRL_cellchat_net.csv')
...
saveRDS(cellchat, file = "../../../data/MultiC_COPD-CTRL_anotated.rds")
