...
ad_object <- ad$read_h5ad("../../../data/Mixed_COPD-CTRL_anotated.h5ad")
...
head(df.net)
write.table(df.net, sep = ',', row.names = FALSE, './inferences/Mixed_COPD-CTRL_cellchat_net.csv')
...
saveRDS(cellchat, file = "../../../data/Mixed_COPD-CTRL_anotated.rds")
