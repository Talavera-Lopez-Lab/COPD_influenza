...
ad_object <- ad$read_h5ad("../../../data/MultiC_Healthy-IAV_anotated.h5ad")
...
head(df.net)
write.table(df.net, sep = ',', row.names = FALSE, './inferences/MultiC_Healthy-IAV_cellchat_net.csv')
...
saveRDS(cellchat, file = "../../../data/MultiC_Healthy-IAV_anotated.rds")
